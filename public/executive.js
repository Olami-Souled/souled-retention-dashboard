...
// NOTE: The "Number of Souled Students" chart and its overlays (capacity, registrations,
// CPL) used to live here as a third tab. It's been promoted to its own page —
// /acquisition-capacity.html (and acquisition-capacity.js) — because it's a
// different *kind* of analysis from the executive-KPI tabs.
// (See: public/acquisition-capacity.html and acquisition-capacity.js)

document.addEventListener('DOMContentLoaded', () => {
  // Design toggle (KPI Cards / Table View)
  document.querySelectorAll('.design-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      const design = btn.dataset.design;
      document.querySelectorAll('.design-btn').forEach(b => b.classList.toggle('active', b === btn));
